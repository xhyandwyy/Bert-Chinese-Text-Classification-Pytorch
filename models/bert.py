...
class Config(object):
    ...
    def __init__(self, dataset):
        ...
        self.train_path = dataset + '/train.tsv'                                # 训练集
        self.dev_path = dataset + '/dev.tsv'                                    # 验证集
        self.test_path = dataset + '/test.tsv'                                  # 测试集
        self.class_list = [x.strip() for x in open(
            dataset + '/label_list').readlines()]                                # 类别名单
        self.save_path = dataset + '/saved_dict_kc_lr/'        # 模型训练结果
        ...
        self.layer_learning_rate_decay = 0.95
